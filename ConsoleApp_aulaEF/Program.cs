using ConsoleApp_aulaEF.DataModels;
using System.ComponentModel.DataAnnotations;
using ConsoleApp_aulaEF;
using System.Security.Cryptography;
using Microsoft.EntityFrameworkCore;

namespace ConsoleApp_aulaEF
{
            ...
            switch (op)
            {
                ...
                case 3:
                    try
                    {
                        ...
                        Pessoa p = contexto.Pessoas.Find(idE);
                ...
                case 4:
                  ...
                  case 5:
                        List<Pessoa> pessoas = (from Pessoa p in contexto.Pessoas select p).Include(p => p.emails).ToList<Pessoa>();
                 ...
                 case 6:
                    ...
                    {
                        Console.WriteLine("t" + item.email);
                    }
